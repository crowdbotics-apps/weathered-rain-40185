"""
Django settings for weathered_rain_40185 project.
...
ROOT_URLCONF = 'weathered_rain_40185.urls'
...
WSGI_APPLICATION = 'weathered_rain_40185.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "weathered_rain_40185 API",
    "DESCRIPTION": "API documentation for weathered_rain_40185 App",
    "VERSION": "v1",
}
